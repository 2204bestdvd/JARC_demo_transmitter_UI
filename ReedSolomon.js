...
/* Javascript implementation of Reed Solomon code
 * https://github.com/louismullie/erc-js
 * Specify the number of redundancy bits as input argument, nSym
 * Default to 10 if input is 0
 * Maximum data chunk size (codeword length) is 255
 */
